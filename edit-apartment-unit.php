...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Edit an Apartment Unit</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
  ...
  <div class="form-group mb-3">
    ...
    <input type="number" class="form-control" id="floor_number" name="floor_number" placeholder="Enter Floor Number">
  </div>
  <div class="form-group mb-3">
  ...
  <div class="form-group mb-3">
    ...
    <input type="number" class="form-control" id="unit_number" name="unit_number" placeholder="Enter Unit Number" required>
  </div>
  <div class="form-group mb-3">
  ...
  <div class="form-group mb-3">
    ...
    <input type="tel" class="form-control" id="owner_contact_number_1" name="owner_contact_number_1" placeholder="Enter Owner Contact Number">
  </div>
  <div class="form-group mb-3">
    <label for="owner_contact_number_2">Owner Contact Number 2 (Optional):</label>
    <input type="tel" class="form-control" id="owner_contact_number_2" name="owner_contact_number_2" placeholder="Enter Owner Contact Number">
  </div>
  <div class="form-group mb-3">
    <label for="owner_email">Owner Email:</label>
    <input type="email" class="form-control" id="owner_email" name="owner_email" placeholder="Enter Owner Email" required>
  </div>
  <div class="form-group mb-3">
    <label for="square_footage">Square Footage:</label>
    <input type="number" class="form-control" id="square_footage" name="square_footage" placeholder="Enter Square Footage" required>
  </div>
  <div class="form-group mb-3">
